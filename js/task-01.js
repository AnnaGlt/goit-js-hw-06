...
categoriesEl.forEach(function (categoriesEl) {
    console.log('Category:', categoriesEl.children[0].textContent);
    console.log('Elements:', categoriesEl.children[1].children.length);
});
